...
// Filtering Canvas Scripts
window.addEventListener('resize', function () {

    if (window.matchMedia('screen and (max-width: 1399.98px)').matches) {

        let filterButton = document.getElementsByClassName('filter-canvas-btn');
        filterButton[0].addEventListener("click", filterButtonStyles);

        function filterButtonStyles() {

            let filterCanvas = document.getElementsByClassName('filter-canvas');
            filterCanvas[0].classList.toggle("filter-canvas-show")
        ...
        let filterCanvas = document.getElementsByClassName('filter-canvas');
        filterCanvas[0].classList.remove("filter-canvas-show")
...
var advertisingSwiper = new Swiper(".advertisingSwiper", {
    slidesPerView: 5,
    spaceBetween: 15,
    slidesPerGroup: 1,
    loop: true,
...
var categorymainSwiper = new Swiper(".categorymainSwiper", {
    slidesPerView: 4,
    spaceBetween: 20,
    slidesPerGroup: 1,
    loop: true,
...
lightGallery(document.querySelector(".advertisingsingle .gallery"), {
    plugins: [
        lgZoom,
        lgAutoplay,
        // lgComment,
